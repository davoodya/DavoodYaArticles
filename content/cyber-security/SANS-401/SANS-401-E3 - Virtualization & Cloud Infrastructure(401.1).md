+++
title = "SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)"
...
#### Definitions
0. Virtual Machines
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-1](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-1.png)
1. Virtualization Overview
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-2](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-2.png)
2. How Virtualization Works?
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-3](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-3.png)
3. Benefits & Users
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-4](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-4.png)
4. Virtual Machines Attacks
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-5](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-5.png)
...
1. *Hyperjacking*
	...
	2. *Gain Access to all VMs:*
		...
		2. در واقع این نوع از حملات به یک لایه بالاتر نسب به حمله نوع اول انجام میشود:
			1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-6](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-6.png)
2. *VM Escapes*
...
5. *Inherent Vulnerabilities* 
	...
	2. *Multiple sets of vulnerabilities* 
		1. در این لایه میانی چندین آسیب پذیری وجود دارد که با استفاده از آن Attacker نفوذ خود را انجام میدهد.
			1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-7](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-7.png)
		2. تصویر
			1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-8](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-8.png)
6. *Other Attacks*
	1. Hyper Jumping
	2. Rowhammer
	3. Blue Pill
		1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-9](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-9.png)
...
8. Image
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-10](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-10.png)
...
3. Image
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-11](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-11.png)
...
10. Image
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-12](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-12.png)
	2. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-13](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-13.png)
	3. 
...
3. Image
	1. ![SANS-401-E3 - Virtualization & Cloud Infrastructure(401.1)-14](/images/cyber-security/SANS-401-E3-Virtualization&CloudInfrastructure(401.1)-14.png)
### !