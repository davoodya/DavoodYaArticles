...
- اگر بخواهیم این پروتکل ها را بصورت تخصصی آنالیز کنیم و یا داده هایی که در این پروتکل های جابجا میشوند را مشاهده و بررسی کنیم باید از ابزار های خاص بررسی مانند، `tcpdump` در ترمینال و یا `Wireshark` که نسخه GUI دارد استفاده کنیم.
	- ![SANS-401-Networking and Protocols (401.1)-1](/images/cyber-security/Pastedimage20240620165523.png)
...
tcpdump --help
```
	![SANS-401-Networking and Protocols (401.1)-2](/images/cyber-security/Pastedimage20240620165923.png)
#### Basic Usages
##### 0. tcpdump Flags & Conditions
###### 0.1 Flags
0. `tcpdump -h`
	1. ![SANS-401-Networking and Protocols (401.1)-3](/images/cyber-security/Pastedimage20240620170018.png)
1. `tcpdump -i eth0`
...
4. `tcpdump -X`
	1. جواب Capturing را بصورت ASCI Code(Binary) نشان میدهد:
		1. ![SANS-401-Networking and Protocols (401.1)-4](/images/cyber-security/Pastedimage20240620175636.png)
5. `tcpdump -a`
...
tcpdump -i lo
```
	![SANS-401-Networking and Protocols (401.1)-5](/images/cyber-security/Pastedimage20240620170629.png)
حال اگر ترافیکی از این ماشین عبور کند و یا ترافیکی به این ماشین وارد شود، پکت های ترافیک توسط tcpdump بصورت Capture میشوند، ساده ترین روش تولید ترافیک هم پینگ گرفتن یک مقصد خاص است. در واقع اگر در ترمینال جدیدی در ماشین لینوکسی `ping 127.0.0.1 -c 1` را بگیریم میتوانیم مشاهده کنیم که بسته پینگ توسط `tcpdump` کپچر شده است:
	![SANS-401-Networking and Protocols (401.1)-6](/images/cyber-security/Pastedimage20240620171105.png)
...
ftp 10.10.10.10
```
	![SANS-401-Networking and Protocols (401.1)-7](/images/cyber-security/Pastedimage20240620174957.png)
	![SANS-401-Networking and Protocols (401.1)-8](/images/cyber-security/Pastedimage20240620175001.png)
...
```
	![SANS-401-Networking and Protocols (401.1)-9](/images/cyber-security/Pastedimage20240620180042.png)
...
ftp>
```
	![SANS-401-Networking and Protocols (401.1)-10](/images/cyber-security/Pastedimage20240620181147.png)
...
5. در کپچر بعدی، هم مشاهده میکنیم که یوزر anonymous به پروتکل ftp ماشین لینوکسی با موفقیت لاگین کرده است.
	1. ![SANS-401-Networking and Protocols (401.1)-11](/images/cyber-security/Pastedimage20240620181551.png)
...
nc 127.0.0.1 333
```
	![SANS-401-Networking and Protocols (401.1)-12](/images/cyber-security/Pastedimage20240620182037.png)
...
2. در کپچر دوم مشاهده میکنیم که بسته TCP با فلگ `R` Reset از سمت 127.0.0.1:333 به سمت ماشین لینوکسی ارسال شده است. فلگ `R` نشان میدهد که Three Way Handshake بین مبدا و مقصد برقرار نشده است و به مراتب کانکشن TCP هم Reset شده است.
	![SANS-401-Networking and Protocols (401.1)-13](/images/cyber-security/Pastedimage20240620182614.png)
### !