...
3. *تصویر:*
	1. ![SANS-401-Defense-in-Depth (401.2)-1](/images/cyber-security/Pastedimage20240621173423.png)
#### Key Focus of Risk
در مبحث Defense-in-Depth هم رعایت مثلث *CIA(Confidentiality, Integrity, Availability)* از واجبات است و بر حسب هر پروژه میتوان ضریب هر ضلع را افزایش و کاهش داد:
	![SANS-401-Defense-in-Depth (401.2)-2](/images/cyber-security/Pastedimage20240621173706.png)
- *Confidentiality*
...
7. Image
	1. ![SANS-401-Defense-in-Depth (401.2)-3](/images/cyber-security/Pastedimage20240621180821.png)
#### Managing Access
...
5. *Image:*
	1. ![SANS-401-Defense-in-Depth (401.2)-4](/images/cyber-security/Pastedimage20240621181416.png)
#### Single-Sign-On (SSO)
...
- *تصویر:*
	- ![SANS-401-Defense-in-Depth (401.2)-5](/images/cyber-security/Pastedimage20240621181800.png)
### Password Management
...
این کرک میتواند براساس Wordlist و یا بصورت کور Bruteforce باشد.
	![SANS-401-Defense-in-Depth (401.2)-6](/images/cyber-security/Pastedimage20240621182040.png)
...
5. Image:
	1. ![SANS-401-Defense-in-Depth (401.2)-7](/images/cyber-security/Pastedimage20240621182546.png)
...
یکی از ابزار های دیگر برای کرک پسورد Cain است که بصورت GUI و در ویندوز استفاده میشود. از این ابزار برای کرک پسورد های ویندوزی با هش NTLM بسیار استفاده میشود. 
	![SANS-401-Defense-in-Depth (401.2)-8](/images/cyber-security/Pastedimage20240621182838.png)
...
6. استفاده از احراز هویت Biometric برای احراز هویت کاربران *Best*
	...
	5. *تصویر:*
			1. ![SANS-401-Defense-in-Depth (401.2)-9](/images/cyber-security/Pastedimage20240621184130.png)
