...
[params.opengraph]
  ...
  url = "https://davoodya.ir/network/network-basics-terminology-topology/"
  type = "article"
...
1. **What is Computer Network?**
	1. Networks Duties
	2. Server Functionality in Networks
#### Network Topologies(Need Notebook)
1. **What is Network Topology?**
	1. *Topology Terminology:*
		1. What is Machine?
		2. What is Host(Server)?
