...
1. وقتیکه خزنده های موتور جستجو به یک وبسایت میرسند در اولین قدم به سراغ فایلی بنام `robots.txt` میگردد:
	1. ![Pasted image 20260122212030.png](/images/seo/Pasted image 20260122212030.png)
...
1. `user-agent`
	...
	3. در URL زیر میتوانیم نام ربات های جستجوگر را مشاهده کنیم که بیش از 300 ربات هستند که هر کدام نیز رفتار مشخصی دارند:
		1. https://robotstxt.org/db.html
			1. ![Pasted image 20260122212638.png](/images/seo/Pasted image 20260122212638.png)
2. `allow:`
...
روش دیگری که برای مدیریت پارامتر های `robots.txt` وجود دارد استفاده از Meta Tags های مربوط به `robots.txt` است که میتوانیم در هر صفحه از آنها استفاده کنیم:
	![Pasted image 20260122213042.png](/images/seo/Pasted image 20260122213042.png)
#### Index, Follow 
1. Follow, No Follow
...
```
- *تصویر:*
	- ![Pasted image 20260122213723.png](/images/seo/Pasted image 20260122213723.png)
...
```
- *Picture:*
	- ![Pasted image 20260122214325.png](/images/seo/Pasted image 20260122214325.png)
