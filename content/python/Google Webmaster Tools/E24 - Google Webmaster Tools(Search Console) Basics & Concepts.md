...
3. After Open, Click on Search Console
	1. ![[Pasted image 20260124144526.png]]
...
6. After Verified you can see new property(your site) in Webmaster Tools plus Main Webmaster Tool Page
	1. Empty Panel: ![[Pasted image 20260124145728.png]]
	2. Toplearn Panel: ![[Pasted image 20260124145637.png]]
...
1. `Webmaster Tools => Current Status => Click on Sitemaps`
	1. ![[Pasted image 20260124145939.png]]
2. Then Click on Add Sitemap
	1. ![[Pasted image 20260124150057.png]]
3. Enter URL of Sitemap(sitemap.xml) and Click on Submit
	1. ![[Pasted image 20260124150216.png]]
4. *In Current Status Panel:*
	...
	4. *تصویر:*
		1. ![[Pasted image 20260124154039.png]]
...
1. `Right Gear => Site Settings`
	1. ![[Pasted image 20260124152136.png]]
2. `Preferred Domain => Select => Display URLs as website.com`
	1. ![[Pasted image 20260124152308.png]]
#### UI Description
##### Dashboard
...
2. Crawl Errors
	1. نمایش خطاهای خزنده ها:
		1. ![[Pasted image 20260124154053.png]]
3. Search Analytics 
	1. نمایش آماری کلی تعداد کلیک ها یا همان ورودی هایی که از گوگل وارد وبسایت ما شده اند:
		1. ![[Pasted image 20260124154104.png]]
4. Sitemaps
	1. نمایش وضعیت نقشه سایت و لینک های درون آن:
		1. ![[Pasted image 20260124154111.png]]
5. Image:
	1. ![[Pasted image 20260124153908.png]]
...
- علاوه بر آن در `Dashboard => Messages` نیز میتوانیم این پیام های مهم را مشاهده کنیم:
	![[Pasted image 20260124152502.png]]
...
6. Image:
	1. ![[Pasted image 20260124153624.png]]
##### Search Traffic
...
6. Mobile Usability
7. Image:
	1. ![[Pasted image 20260124153603.png]]
##### Google Index
...
3. Remove URLs
4. Image:
	1. ![[Pasted image 20260124153223.png]]
##### Crawl 
...
6. URL Parameters
7. Image:
	1. ![[Pasted image 20260124153448.png]]
##### Security Issues
در این تب هم مشکلات امنیتی وبسایت در صورت وجود نمایش داده میشوند:
	![[Pasted image 20260124153530.png]]
### !
