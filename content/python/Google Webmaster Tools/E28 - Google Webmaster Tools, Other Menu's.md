...
- کافیست در این ابزار اسکریپت Structured Data خود را بنویسیم و سپس بر روی Run کلیک کنیم تا نتیجه نهایی Structured Data را مشاهده کنیم:
	- ![Pasted image 20260126190618.png](/images/python/Pasted image 20260126190618.png)
...
1. برای پیاده سازی فرم جستجو در وبسایتمان، در لینک زیر قسمت `Sitelinks Searchbox` بر روی `Read the Guide` کلیک میکنیم.
	- https://developers.google.com/search/docs/guides/search-gallery
		- ![Pasted image 20260126185811.png](/images/python/Pasted image 20260126185811.png)
2. سپس در صفحه باز شدن بر روی `SEE MARKUP` کلیک میکنیم تا کدی که برای پیاده سازی فرم جستجو نیاز است را مشاهده کنیم:
	1. ![Pasted image 20260126185940.png](/images/python/Pasted image 20260126185940.png)
3. اسکریپت مورد نیاز مانند تصویر زیر است:
	1. ![Pasted image 20260126190056.png](/images/python/Pasted image 20260126190056.png)
##### Other Data Structured(Rich Cards)
1. **Article Structured Data:**
	1. ![Pasted image 20260126190436.png](/images/python/Pasted image 20260126190436.png)
2. **Social Networks:**
	1. ![Pasted image 20260126190740.png](/images/python/Pasted image 20260126190740.png)
3. **Local Business:** 
	1. ![Pasted image 20260126190700.png](/images/python/Pasted image 20260126190700.png)
4. **Course:**
	1. ![Pasted image 20260126190838.png](/images/python/Pasted image 20260126190838.png)
5. **Job Posting:**
	1. ![Pasted image 20260126190939.png](/images/python/Pasted image 20260126190939.png)
#### 3. Data Highlighter
...
1. Open Data Highlighter and Click on `Start Highlighting`
	1. ![Pasted image 20260126191947.png](/images/python/Pasted image 20260126191947.png)
2. Enter URL of Your Page and Select Structured Data Type then `OK`:
	1. ![Pasted image 20260126192041.png](/images/python/Pasted image 20260126192041.png)
3. *After that, Data Highlighter Open a URL:*
	...
	2. در صفحه باز شده ابزار با بسته به نوع Type که انتخاب کردیم موارد مورد نیاز خود را از ما میخواهد. در این مثال چون Article بود از ما موارد زیر را میخواهد:
		1. ![Pasted image 20260126192713.png](/images/python/Pasted image 20260126192713.png)
4. *Now we should select texts on the page, then right click on texts and select property of selected text:*
	1. در واقع متنی که انتخاب میکنیم را با راست کلیک میتوانیم به پارامتر های لازم اختصاص دهیم:
		1. ![Pasted image 20260126192951.png](/images/python/Pasted image 20260126192951.png)
	2. انتخاب المان را برای تصاویر نیز میتوانیم انجام دهیم:
		1. ![Pasted image 20260126193101.png](/images/python/Pasted image 20260126193101.png)
5. **Note:** `tag this pages and others like it` & `tag just this page`
	1. در اول Data Highlighter دو گزینه `tag just this page` و `tag this pages and others like it` قابل انتخاب هستند:
		1. ![Pasted image 20260126193539.png](/images/python/Pasted image 20260126193539.png)
	...
	4. مثلا برای صفحه محصولات میتوانیم با یک محصول که مشخص میکنیم الگو را برای تمام محصولات بنویسیم:
		1. ![Pasted image 20260126193404.png](/images/python/Pasted image 20260126193404.png)
	5. همچنین با انتخاب `Custom` میتوانیم برای صفحات مشخصی نیز این الگو را تعریف کنیم:
		1. ![Pasted image 20260126193435.png](/images/python/Pasted image 20260126193435.png)
6. Then, Select name and Click on `Create Page Set` to Create for specific pages:
	1. ![Pasted image 20260126193758.png](/images/python/Pasted image 20260126193758.png)
7. Then, we should check other examples and if Click on `Next` & `done`
	1. ![Pasted image 20260126194114.png](/images/python/Pasted image 20260126194114.png)
	2. ![Pasted image 20260126194112.png](/images/python/Pasted image 20260126194112.png)
8. Finally, in Review and Publish Step you can see Created Rich Cards and if OK Click on `PUBLISH`
	1. ![Pasted image 20260126194243.png](/images/python/Pasted image 20260126194243.png)
...
- پس از ساخت اولین Data Highlighter خود در این منو میتوانیم تمامی نمونه ها را مشاهده کنیم:
	- ![Pasted image 20260126194421.png](/images/python/Pasted image 20260126194421.png)
...
- مثلا در تصویر زیر مشاهده میکنیم در `Meta Description` و `Title Tag` وبسایت ما ایراداتی وجود دارد:
	- ![Pasted image 20260126194828.png](/images/python/Pasted image 20260126194828.png)
...
- حال در تصویر زیر مشاهده میکنیم که 8 صفحه دارای ایراد Duplicate Meta Description هستند و 145 دارای ایراد Duplicate title tags میباشند:
	- ![Pasted image 20260126195349.png](/images/python/Pasted image 20260126195349.png)
- حال روی هر خطا نیز کلیک کنیم Meta Description تکراری و آدرس صفحاتی که مقدار تکراری را دارند میتوانیم مشاهده کنیم:
	- ![Pasted image 20260126195455.png](/images/python/Pasted image 20260126195455.png)
	- ![Pasted image 20260126195558.png](/images/python/Pasted image 20260126195558.png)
...
- **مورد اول:** اگر که برای هر صفحه یک لینک فارسی انگلیسی و همچنین یک لینک کوتاه داشته باشیم و تگ `Canonical` را در یکی از آنها تعریف نکنیم(بهتر است در صفحه لینک کوتاه باشد) در اینجا آن صفحه خطای `Duplicate title tags` را میدهد:
	- ![Pasted image 20260126201220.png](/images/python/Pasted image 20260126201220.png)
- **مورد دوم:** اگر یک صفحه دارای صفحه بندی های متفاوت باشد مثلا یک مطلب انجمن که در آن پرسش و پاسخ مطرح شده است و دارای چندین صفحه است، و در آن صفحات تگ `Canonical` را با لینک صفحه اول(اصلی) تعریف نکرده باشیم نیز در اینجا به خطای `Duplicate title tags` برمیخوریم:
	- ![Pasted image 20260126201206.png](/images/python/Pasted image 20260126201206.png)
...
- برای خواندن مطالب بیشتر در این مورد به [لینک](https://www.ampproject.org/docs/fundamentals/) زیر بروید:
	- https://www.ampproject.org/docs/fundamentals/
		- ![Pasted image 20260126201831.png](/images/python/Pasted image 20260126201831.png)
		- ![Pasted image 20260126201752.png](/images/python/Pasted image 20260126201752.png)
...
```
- *Picture:*
	- ![Pasted image 20260126202318.png](/images/python/Pasted image 20260126202318.png)
##### Convert HTML to AMP *Research Topic*
### Crawl
#### 1. Crawl Errors
##### Description
در این منو خطاهایی که خزنده گوگل در خزش وبسایت ما به آنها برخورده است را مشاهده میکنیم:
	![Pasted image 20260126202833.png](/images/python/Pasted image 20260126202833.png)
- **Crawl Error Types:**
	1. Server Errors:
		1. خطاهای سروری در این قسمت مشاهده میشوند:
			1. ![Pasted image 20260126203036.png](/images/python/Pasted image 20260126203036.png)
	2. Access Denied:
		1. صفحاتی که گوگل نتوانسته به آنها دسترسی داشته باشد:
			1. ![Pasted image 20260126203102.png](/images/python/Pasted image 20260126203102.png)
	3. Not Found:
		1. صفحاتی که خزنده های گوگل آنها را نیافته است:
			1. ![Pasted image 20260126203238.png](/images/python/Pasted image 20260126203238.png)
	4. Other
##### Not Found URL
...
1. **Avoid from Not Found URL:**
	...
	2. سپس URL را به عنوان حذف شده معرفی میکنیم:
		1. ![Pasted image 20260126203854.png](/images/python/Pasted image 20260126203854.png)
	3. سپس نوع حذف را مشخص میکنیم که پر استفاده ترین آن `Temporarily hide pag from search results and remove from cache` میباشد:
		1. ![Pasted image 20260126204028.png](/images/python/Pasted image 20260126204028.png)
...
2. **Fix Not Found Errors:**
	...
	- ![Pasted image 20260126203408.png](/images/python/Pasted image 20260126203408.png)
##### Fix Crawler Errors
...
اگر لینکی توسط موتور جستجو ایندکس نشده بود برای معرفی دستی این لینک به موتور جستجو گوگل از این گزینه استفاده میکنیم:
	![Pasted image 20260126211617.png](/images/python/Pasted image 20260126211617.png)
...
در این قسمت هم فایل robots.txt وبسایت قابل مشاهده و همچنین قابل ویرایش است:
	![Pasted image 20260126210828.png](/images/python/Pasted image 20260126210828.png)
#### 4. Sitemaps
در این قسمت وضعیت لینک های نقشه سایت را مشاهده میکنیم. لینک های ایندکس شده آبی و لینک هایی که ایندکس نشده اند به رنگ قرمز نمایش داده میشوند:
	![Pasted image 20260126211251.png](/images/python/Pasted image 20260126211251.png)
#### 5. URL Parameters
در این قسمت نیز پارامتر هایی که در تعریف URL ها بیشترین استفاده را داشته اند را مشاهده میکنیم:
	![Pasted image 20260126211422.png](/images/python/Pasted image 20260126211422.png)
### Security Issue
...
در منو Web Tools هم ابزار های دیگر Google برای وبسایت ها را میتوان مشاهده کرد:
	![Pasted image 20260126212540.png](/images/python/Pasted image 20260126212540.png)
...
2. **Testing Tools:**
	...
	- Email Markup Tester
	- Image:
		- ![Pasted image 20260126212716.png](/images/python/Pasted image 20260126212716.png)
3. Other Resources
### !