...
1. `Google Analytics => Conversion => Goals => Overview => Setup Goals`
	1. برای تعریف هدف ها در منو Overview بر روی Setup Goals کلیک میکنیم:
		1. ![Pasted image 20260131161208.png](/images/python/Pasted image 20260131161208.png)
	2. سپس هم در صفحه باز شده بر روی New Goal کلیک میکنیم تا هدف جدید را تعریف کنیم:
		1. ![Pasted image 20260131161526.png](/images/python/Pasted image 20260131161526.png)
2. `Google Analytics => Settings Gear => Goals`
	1. روش دیگر تعریف هدف ها رفتن به منو بالاست که در واقع با کلیک بر روی Setup Goals هم به این منو منتقل میشویم:
		1. ![Pasted image 20260131161437.png](/images/python/Pasted image 20260131161437.png)
	...
	2. *Goal Setup:*
		1. *Template:*
			1. در این گزینه میتوانیم از قالب های موجود در Google Analytics که برای ساخت هدف موجود است استفاده کنیم:
				1. ![Pasted image 20260131161838.png](/images/python/Pasted image 20260131161838.png)
		...
		2. *Custom:*
			...
			4. *Type:*
				...
				6. *Image:*
					1. ![Pasted image 20260131162823.png](/images/python/Pasted image 20260131162823.png)
			5. *Goal Details => Destination:*
				...
				4. برای مقایسه این مقصد از Equal to, Begins With , Regular Expression میتوان استفاده کرد:
					1. ![Pasted image 20260131163351.png](/images/python/Pasted image 20260131163351.png)
			6. *Value:*
			...
			8. *Save:*
				1. ![Pasted image 20260131163403.png](/images/python/Pasted image 20260131163403.png)
	3. *See Created Goals:*
		1. پس از اینکه هدف مورد نظر را ساختیم آنرا در جدول هدف ها مشاهده میکنیم و درصدی که به آن هدف نزدیک شده ایم را میتوانیم ببینیم:
			1. ![Pasted image 20260131163545.png](/images/python/Pasted image 20260131163545.png)
...
4. **See Goal Details:**
	...
	3. نتیجه هدف در `Google Analytics => Settings Gear => Goals`
		1. ![Pasted image 20260131164349.png](/images/python/Pasted image 20260131164349.png)
	4. نتیجه هدف در `Google Analytics => Conversion => Goals`
		1. ![Pasted image 20260131164529.png](/images/python/Pasted image 20260131164529.png)
...
6. *Image:*
	1. ![Pasted image 20260131165802.png](/images/python/Pasted image 20260131165802.png)
#### 2. Overview
1. **Description:**
	1. در این پنجره آمار کلی از اهداف با Metric های تعریف شده مشاهده میشود:
		1. ![Pasted image 20260131165853.png](/images/python/Pasted image 20260131165853.png)
...
3. **Goal Completion Locations:**
	1. در پایین صفحه نیز صفحاتی که اهداف ما در آن صفحات انجام میشوند را مشاهده میکنیم:
		1. ![Pasted image 20260131170034.png](/images/python/Pasted image 20260131170034.png)
#### 3. Goal URLs
در این گزینه آمار Goal Completion Locations بصورت کلی و دقیق با جزئیات نمایش داده میشود:
	![Pasted image 20260131170357.png](/images/python/Pasted image 20260131170357.png)
...
2. همچنین میتوانیم این آمار را برای یک هدف مشخص نشان دهیم که برای اینکار میتوانیم از فیلتر بالای صفحه استفاده کنیم:
	1. ![Pasted image 20260131170537.png](/images/python/Pasted image 20260131170537.png)
#### 4. Reverse Goal Path
در این گزینه مراحلی(صفحات) که کاربر طی کرده تا به هدف ما برسد و آنرا done کند را مشاهده میکنیم:
	![Pasted image 20260131170655.png](/images/python/Pasted image 20260131170655.png)
